...
class Config(object):
    ...
    UPSTREAM_REPO = get_config("UPSTREAM_REPO", "https://github.com/itskrishname/hk-pvt-encoder-TG-GUY.git")
    UPSTREAM_BRANCH = get_config("UPSTREAM_BRANCH", "update-command-15316860071948776463")
